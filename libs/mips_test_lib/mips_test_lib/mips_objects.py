...
class MipsObjects(Enum, metaclass=DirectValueMeta):
    ...
    class Regs(Enum, metaclass=DirectValueMeta):
        ...
        # FP registers (32-bit each; doubles use pairs: even reg = low 32 bits, odd reg = high 32 bits)
        F0  = MipsObject("F0",  "U_MIPS_R2000.U_FPR.fprRegisters[0]",  32)
        F1  = MipsObject("F1",  "U_MIPS_R2000.U_FPR.fprRegisters[1]",  32)
        F2  = MipsObject("F2",  "U_MIPS_R2000.U_FPR.fprRegisters[2]",  32)
        F3  = MipsObject("F3",  "U_MIPS_R2000.U_FPR.fprRegisters[3]",  32)
        F4  = MipsObject("F4",  "U_MIPS_R2000.U_FPR.fprRegisters[4]",  32)
        F5  = MipsObject("F5",  "U_MIPS_R2000.U_FPR.fprRegisters[5]",  32)
        F6  = MipsObject("F6",  "U_MIPS_R2000.U_FPR.fprRegisters[6]",  32)
        F7  = MipsObject("F7",  "U_MIPS_R2000.U_FPR.fprRegisters[7]",  32)
        F8  = MipsObject("F8",  "U_MIPS_R2000.U_FPR.fprRegisters[8]",  32)
        F9  = MipsObject("F9",  "U_MIPS_R2000.U_FPR.fprRegisters[9]",  32)
        F10 = MipsObject("F10", "U_MIPS_R2000.U_FPR.fprRegisters[10]", 32)
        F11 = MipsObject("F11", "U_MIPS_R2000.U_FPR.fprRegisters[11]", 32)
        F12 = MipsObject("F12", "U_MIPS_R2000.U_FPR.fprRegisters[12]", 32)
        F13 = MipsObject("F13", "U_MIPS_R2000.U_FPR.fprRegisters[13]", 32)
        F14 = MipsObject("F14", "U_MIPS_R2000.U_FPR.fprRegisters[14]", 32)
        F15 = MipsObject("F15", "U_MIPS_R2000.U_FPR.fprRegisters[15]", 32)
        F16 = MipsObject("F16", "U_MIPS_R2000.U_FPR.fprRegisters[16]", 32)
        F17 = MipsObject("F17", "U_MIPS_R2000.U_FPR.fprRegisters[17]", 32)
        F18 = MipsObject("F18", "U_MIPS_R2000.U_FPR.fprRegisters[18]", 32)
        F19 = MipsObject("F19", "U_MIPS_R2000.U_FPR.fprRegisters[19]", 32)
        F20 = MipsObject("F20", "U_MIPS_R2000.U_FPR.fprRegisters[20]", 32)
        F21 = MipsObject("F21", "U_MIPS_R2000.U_FPR.fprRegisters[21]", 32)
        F22 = MipsObject("F22", "U_MIPS_R2000.U_FPR.fprRegisters[22]", 32)
        F23 = MipsObject("F23", "U_MIPS_R2000.U_FPR.fprRegisters[23]", 32)
        F24 = MipsObject("F24", "U_MIPS_R2000.U_FPR.fprRegisters[24]", 32)
        F25 = MipsObject("F25", "U_MIPS_R2000.U_FPR.fprRegisters[25]", 32)
        F26 = MipsObject("F26", "U_MIPS_R2000.U_FPR.fprRegisters[26]", 32)
        F27 = MipsObject("F27", "U_MIPS_R2000.U_FPR.fprRegisters[27]", 32)
        F28 = MipsObject("F28", "U_MIPS_R2000.U_FPR.fprRegisters[28]", 32)
        F29 = MipsObject("F29", "U_MIPS_R2000.U_FPR.fprRegisters[29]", 32)
        F30 = MipsObject("F30", "U_MIPS_R2000.U_FPR.fprRegisters[30]", 32)
        F31 = MipsObject("F31", "U_MIPS_R2000.U_FPR.fprRegisters[31]", 32)
        CC  = MipsObject("CC",  "U_MIPS_R2000.U_FPR.ccFlag",           1)
