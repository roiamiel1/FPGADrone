...
class MipsObjects(Enum, metaclass=DirectValueMeta):
    ...
    REG_ZERO = MipsObject("U_MIPS_R2000.U_GPR.gprRegisters[0]", 32)
    REG_AT = MipsObject("U_MIPS_R2000.U_GPR.gprRegisters[1]", 32)
    REG_V0 = MipsObject("U_MIPS_R2000.U_GPR.gprRegisters[2]", 32)
    REG_V1 = MipsObject("U_MIPS_R2000.U_GPR.gprRegisters[3]", 32)
    REG_A0 = MipsObject("U_MIPS_R2000.U_GPR.gprRegisters[4]", 32)
    REG_A1 = MipsObject("U_MIPS_R2000.U_GPR.gprRegisters[5]", 32)
    REG_A2 = MipsObject("U_MIPS_R2000.U_GPR.gprRegisters[6]", 32)
    REG_A3 = MipsObject("U_MIPS_R2000.U_GPR.gprRegisters[7]", 32)
    REG_T0 = MipsObject("U_MIPS_R2000.U_GPR.gprRegisters[8]", 32)
    REG_T1 = MipsObject("U_MIPS_R2000.U_GPR.gprRegisters[9]", 32)
    REG_T2 = MipsObject("U_MIPS_R2000.U_GPR.gprRegisters[10]", 32)
    REG_T3 = MipsObject("U_MIPS_R2000.U_GPR.gprRegisters[11]", 32)
    REG_T4 = MipsObject("U_MIPS_R2000.U_GPR.gprRegisters[12]", 32)
    REG_T5 = MipsObject("U_MIPS_R2000.U_GPR.gprRegisters[13]", 32)
    REG_T6 = MipsObject("U_MIPS_R2000.U_GPR.gprRegisters[14]", 32)
    REG_T7 = MipsObject("U_MIPS_R2000.U_GPR.gprRegisters[15]", 32)
    REG_S0 = MipsObject("U_MIPS_R2000.U_GPR.gprRegisters[16]", 32)
    REG_S1 = MipsObject("U_MIPS_R2000.U_GPR.gprRegisters[17]", 32)
    REG_S2 = MipsObject("U_MIPS_R2000.U_GPR.gprRegisters[18]", 32)
    REG_S3 = MipsObject("U_MIPS_R2000.U_GPR.gprRegisters[19]", 32)
    REG_S4 = MipsObject("U_MIPS_R2000.U_GPR.gprRegisters[20]", 32)
    REG_S5 = MipsObject("U_MIPS_R2000.U_GPR.gprRegisters[21]", 32)
    REG_S6 = MipsObject("U_MIPS_R2000.U_GPR.gprRegisters[22]", 32)
    REG_S7 = MipsObject("U_MIPS_R2000.U_GPR.gprRegisters[23]", 32)
    REG_T8 = MipsObject("U_MIPS_R2000.U_GPR.gprRegisters[24]", 32)
    REG_T9 = MipsObject("U_MIPS_R2000.U_GPR.gprRegisters[25]", 32)
    REG_K0 = MipsObject("U_MIPS_R2000.U_GPR.gprRegisters[26]", 32)
    REG_K1 = MipsObject("U_MIPS_R2000.U_GPR.gprRegisters[27]", 32)
    REG_GP = MipsObject("U_MIPS_R2000.U_GPR.gprRegisters[28]", 32)
    REG_SP = MipsObject("U_MIPS_R2000.U_GPR.gprRegisters[29]", 32)
    REG_FP = MipsObject("U_MIPS_R2000.U_GPR.gprRegisters[30]", 32)
    REG_RA = MipsObject("U_MIPS_R2000.U_GPR.gprRegisters[31]", 32)
